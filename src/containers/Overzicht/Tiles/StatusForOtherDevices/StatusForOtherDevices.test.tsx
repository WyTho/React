...
import {StatusForOtherDevices} from './StatusForOtherDevices';
...
describe('<StatusForOtherDevices /> (component)', () => {
    let wrapper: any;
    ...
    beforeEach(() => wrapper = shallow(<StatusForOtherDevices {...props} />));
    it('should be defined', () => {
        expect(StatusForOtherDevices).toBeDefined();
    });
    it('should render', () => {
    ...
    it('should not have more than 0 Grid component if there is data', () => {
        ...
        const withDataWrapper = shallow(<StatusForOtherDevices {...withDataProps} />);
