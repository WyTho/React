...
import {ChartForWaterUsage} from './ChartForWaterUsage';
...
describe('<ChartForWaterUsage /> (component)', () => {
    let wrapper: any;
    ...
    const props = {
        ...
        error: false,
        dataset: {
            [DataSet.AVERAGE_WATER_USAGE]: null as IApiGraph
        }
    };
    beforeEach(() => wrapper = shallow(<ChartForWaterUsage {...props} />));
    it('should be defined', () => {
        expect(ChartForWaterUsage).toBeDefined();
    });
    it('should render', () => {
    ...
    it('should not have more than 0 Grid component if there is data', () => {
        ...
        const withDataWrapper = shallow(<ChartForWaterUsage {...withDataProps} />);
